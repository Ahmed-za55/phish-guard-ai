...
MAX_IMAGE_SIZE = int(
    os.getenv("MAX_IMAGE_SIZE", str(10 * 1024 * 1024))
)
...
def safe_error(
    ...
    """
    Return a safe API error without exposing internal exception details.
    """
...
def check_rate_limit(request: Request) -> None:
    """
    Enforce rate limiting by raising an HTTPException 429 directly.
    """
...
def analyze(
    ...
    try:
        ...
        # Do not expose Gemini/API/internal exception details.
        raise safe_error(
            "Text analysis is temporarily unavailable.",
            503,
        )
